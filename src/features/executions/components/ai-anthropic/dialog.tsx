        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-2xl">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Configure settings for the Anthropic Claude AI processing node.
                    </DialogDescription>
                </DialogHeader>
                <Form {...form}>
                    <form
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormDescription>
                                        ...
                                        Anthropic Claude model to use for processing. Update available models in the code as needed.
                                    </FormDescription>
                                    <FormMessage />
                                </FormItem>
                            )}
